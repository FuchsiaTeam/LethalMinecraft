        ...
        if (client != null) {
            if (SHOW) {
                ...
                if(ClientEndTickListener.pickupCharge > 0) {
                    ...
                    drawContext.drawTexture(OVERLAY_TEX, x, y + 15, 0, 0,128, 8);
                    drawContext.drawText(client.textRenderer, (int)((float)ClientEndTickListener.pickupCharge / (float)ClientEndTickListener.maxPickupCharge * 100.0f) + "%", x, y + 16, 0xFFFFFFFF, true);
                }
            }
        }
    }
